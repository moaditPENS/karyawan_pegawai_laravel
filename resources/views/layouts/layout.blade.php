...
<head>
    ...
    <title>LARAVEL INFORMASI DATA PEGAWAI</title>
    <!-- CSRF Token -->
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="" class="brand-logo">
                {{-- <img class="logo-abbr" src="{{ asset('images/biis.png') }}" alt="">
                <img class="logo-compact" src="{{ asset('images/biis.png') }}" alt=""> --}}
                <img class="brand-title" src="{{ asset('images/biis.png') }}" alt="">
            </a>
