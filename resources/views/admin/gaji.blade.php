                    ...
                    <table class="table table-striped table-bordered table-lg" id="table_gaji">
                        <thead>
                            <tr>
                                ...
                                <th>Kurang bayar</th>
                                <th>Iuran Kesehatan Pegawai</th>
                                <th>Iuran Kesehatan Perusahaan</th>
                                <th>Iuran Ketenagakerjaan Pegawai</th>
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-3">
                                        <label for="unpaid">Kesehatan Pegawai</label>
                                    ...
                                    <div class="form-group col-md-3">
                                        <label for="potongan_koperasi">Ketenagakerjaan Pegawai</label>
